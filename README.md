...
- [`art/starters/`](art/starters/) — Sproutling, Sparkpup, and Cottonwisp (starters-v1.2-face). The board uses the 64px static sheet; tight lists use 32. Idle is 6 frames at 5 FPS on one shared clock: a blink on frame 03, and a 1px eye drift on frames 01 and 04. Merge is a 6-frame one-shot at 9 FPS, then idle. Every other species stays a capsule. `assets/drops/starters-v1.1-subtle/` keeps the previous sheets.
