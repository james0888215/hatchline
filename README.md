...
3. The **Meadow Stall** opens next. Buy, Freeze, Reroll, and sell. Two copies of something you already own fill the first slots, so a clean starter can triple before the grass. Buy and Reroll show the coin cost after a middot (`Buy · 3`, `Reroll · 1`).
