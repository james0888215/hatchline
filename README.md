...
Sky art is edermunizz, [Simple Pastel Backgrounds](https://edermunizz.itch.io/free-simple-pastel-backgrounds) (attribution required). Hill layers are najjar320 VISTA (CC0). Clouds are GarzettDev. The paper veil is CC0. The painted alternate, if used, is heartpunch (CC0). Starter bodies are Anêmonônima, [Blob/Slime collection](https://opengameart.org/content/blobslime-collection) (CC0). Family marks are Hatchline Art.
