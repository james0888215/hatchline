...
| Card chrome | Rounded rect, thick charcoal outline (~4 px idle / ~7 px selected), fill `#FAF6EE`, generous padding. Portrait body height **~122 px** (band ~120–160). Name under portrait; optional family cue (Leaf / Ember / Puff) muted charcoal, small. |
